...
# Reserved words as extracted from MogDB docs.
...
RESERVED_WORDS = set([
    ...
    "binary", "binary_double", "binary_float", "binary_integer", "bit",
    "boolean", "both", "bucketcnt", "buckets", "byteawithoutorder",
    "byteawithoutorderwithequal", "case", "cast", "char", "character",
    "check", "coalesce", "collate", "collation", "column", "compact",
    "concurrently", "constraint", "create", "cross", "csn",
    "current_catalog", "current_date", "current_role", "current_schema",
    "current_time", "current_timestamp", "current_user", "date", "dec",
    "decimal", "decode", "default", "deferrable", "deltamerge", "desc",
    "distinct", "do", "else", "end", "except", "excluded", "exists",
    "extract", "false", "fenced", "fetch", "float", "for", "foreign",
    "freeze", "from", "full", "grant", "greatest", "group", "grouping",
    "groupparent", "having", "hdfsdirectory", "ilike", "in", "initially",
    "inner", "inout", "int", "integer", "intersect", "interval", "into",
    "is", "join", "leading", "least", "left", "less", "like", "limit",
    "localtime", "localtimestamp", "maxvalue", "minus", "modify",
    "national", "natural", "nchar", "nlssort", "none", "not", "notnull",
    "null", "nullif", "number", "numeric", "nvarchar2", "nvl", "offset",
    "on", "only", "or", "order", "out", "outer", "overlaps", "overlay",
    "performance", "placing", "position", "precision", "primary",
    "procedure", "real", "recyclebin", "references", "reject",
    "returning", "right", "row", "rownum", "select", "session_user",
    "setof", "similar", "smalldatetime", "smallint", "some", "substring",
    "symmetric", "sysdate", "systimestamp", "table", "tablesample",
    "then", "time", "timecapsule", "timestamp", "timestampdiff",
    "tinyint", "to", "trailing", "treat", "trim", "true", "union",
